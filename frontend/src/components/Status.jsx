...
export function Status({ loading, error, empty, emptyMessage = "Nothing to show yet.", children }) {
  ...
  if (empty) return <p className="rounded-lg border border-fuel-line bg-white p-4 text-sm font-bold text-slate-600 shadow-sm">{emptyMessage}</p>;
  return children;
}
